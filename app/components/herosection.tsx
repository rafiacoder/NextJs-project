    ...
    <div className="relative w-full h-[780px] lg:h-auto overflow-x-hidden" id="hero">
     ...
     {/* Dubai Design */}
          <div className=" container mx-auto relative w-full  max-w-4xl mx-auto lg:m-6  md:mx-0 items-center md:items-start flex flex-col pt-24 pb-48 sm:pb-52 md:pt-24">
            ...
            <div className=" flex flex-col gap-6 w-full sm:h-auto md:p-6 md:m-6 max-w-full">
              ...
              <div className="flex flex-row gap-2 sm:gap-6 w-full max-w-md mx-auto justify-center md:max-w-none md:mx-0 md:justify-start">
                <Button text="Register" href="/contact" className="border-0 flex-1 min-w-0 justify-center px-3 sm:px-8 text-xs sm:text-[14px] md:flex-initial md:w-auto" />
                <Button text="Find Out More" href="/resources" className="bg-[#4B2417] text-white border-0 flex-1 min-w-0 justify-center px-3 sm:px-8 text-xs sm:text-[14px] md:flex-initial md:w-auto" />
              </div>
            </div>
          </div>
      {/* Key Features */}
          <div className="absolute bottom-8 lg:bottom-22 left-6 right-6 lg:left-[86px] lg:right-[86px] z-10 lg:px-4 lg:px-6  ">
            <div className="container mx-auto bg-white/10 backdrop-blur-md rounded-lg px-8 py-8  ">
              <h1 className="text-xl sm:text-2xl text-white mb-4 sm:mb-6">Key Features</h1>

              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 sm:gap-6 text-white ">
                <div className="flex items-center gap-3">
                  <FaCheckCircle className="w-4 h-4 text-white" />
                  <p className="text-sm ">1-3 bedroom units & duplex penthouses</p>
                </div>

                <div className="flex items-center gap-3">
                  <FaCheckCircle className="w-4 h-4 text-white" />
                  <p className="text-sm">Located in Dubai Design District</p>
                </div>

                <div className="flex items-center gap-3">
                  <FaCheckCircle className="w-4 h-4 text-white" />
                  <p className="text-sm">Burj Khalifa & Downtown Dubai views</p>
                </div>
              </div>
            </div>
          </div>
