...
return(
    <div className=" px-4 sm:px-6 md:px-8 lg:px-10 w-full h-auto ">
        <div className="container mx-auto flex flex-col items-start lg:items-center justify-center  ">
            ...
            <h1 className="text-3xl pl-3 lg:text-3xl  text-start lg:text-center ">
                ARTISTRY ONE RESIDENCES
            </h1>
            <div className="pl-3 ">
            <button className="bg-[#F4F1EB] medium rounded-sm p-2 font-body text-sm mt-5 w-40.75 "> 
                Available - Off Plan
            </button>
            </div>
            <h1 className="text-xl lg:text-2xl pl-3 medium text-center mt-4">
                LIVING AS AN ART FROM 
            </h1>
            <p className="text-start lg:text-center px-3.5 text-sm lg:text-[16px]  text-balanced text-gray-600 mt-4">
          ...
          <Image src={residence} alt="residence" className=" w-full h-auto  p-3.5 object-cover" />
          </div>
        </div>
