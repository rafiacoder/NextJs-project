...
export default function KeyFloorPlans() {
            ...
            >
              <div className="overflow-hidden rounded-md">
                <Image
                  ...
                  width={1200}
                  height={1000}
                  className="h-65 md:h-80 w-full object-cover transition-transform duration-200 hover:scale-[1.03]"
                />
              </div>
            </div>
          ))}
