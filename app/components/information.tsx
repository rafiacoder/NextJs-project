    ...
    return(
        <div className="relative w-full h-full  overflow-hidden ">
            ...
            <div className="container mx-auto  flex flex-col items-center justify-center gap-6 max-w-4xl h-full m-10">
                <h1 className="w-92 lg:w-150 p-3  text-white text-lg lg:text-3xl font-extrabold lg:w-201.25 text-center uppercase  ">
                ...
                <div className="flex flex-col md:flex-row px-4 lg:px-0 text-nowrap gap-2  lg:gap-4">
                  <Button text="Register Now" href="/register" className="border-0 py-5" />
